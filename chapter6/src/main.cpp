...
void App::createGraphicsPipeline() {
  vec<char> vert = Util::readFile("assets/shaders/chapter6/shader.vert.spv");
  vec<char> frag = Util::readFile("assets/shaders/chapter6/shader.frag.spv");
...
int main() {
  VulkanTutorial::Chapter6::App app;
