...
void App::createImageViews() {
  ...
  for (u32 i = 0; i < mSwapchainImages.size(); ++i) {
    mSwapchainImageViews[i] = this->createImageView(
...
void App::createGraphicsPipeline() {
  vec<char> vert = Util::readFile("assets/shaders/chapter8/shader.vert.spv");
  vec<char> frag = Util::readFile("assets/shaders/chapter8/shader.frag.spv");
...
void App::createDepthResources() {
  ...
  this->transitionImageLayout(mDepthImage, depthFormat,
...
void App::createImage(uint32_t width, uint32_t height, VkFormat format,
...
void App::createTextureImageView() {
  mTextureImageView = this->createImageView(mTexture, VK_FORMAT_R8G8B8A8_SRGB,
...
int main() {
  VulkanTutorial::Chapter8::App app;
